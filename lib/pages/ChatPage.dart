...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<String> sendChatMessage(String message) async {
    final url = Uri.parse('$webURL/embedded_chat');
  ...
  Future<String> sendChatConversation(
    ...
    final url = Uri.parse('$webURL/chat');
    final headers = {'Content-Type': 'application/json'};
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        onSubmitted: (value) {
                          _handleSendButtonPressed(); //_handleSendPressed,
                        },
                  ...
                  IconButton(
                    ...
                    onPressed: _handleSendButtonPressed, //_handleSendPressed,
                    color: Colors.green,
                  ),
                ],
              ),
